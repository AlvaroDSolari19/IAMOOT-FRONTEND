    ...
    return (
        <div className="d-grip gap-2">
            <Card className='text-center mb-2'>
                ...
                <Card.Header as="h2" className="display-6 fw-bold">
                    {actualText.mainTitle}
                </Card.Header>
            </Card>
